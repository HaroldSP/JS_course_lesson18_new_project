...
1. Если ввести некорректные данные в форму и отправить выскакивает алерт с сообщением о том, что данные не корректны.
И дальше начинается бесконечный лоадер, которого не должно быть, так как отправка формы и не произошла.
2. Запустить таймер
